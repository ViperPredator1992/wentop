...
class ActionDownloadSxgeo extends DatabaseFileAction {
    ...
    public function __construct($lang) {
        ...
        $text_manual = sprintf($this->lang('text_sxgeo_manual_upload'), dirname(CityManager::getSxgeoPath()) . '/');
        $this->lang['error_create_dir'] = $this->lang('error_create_dir') . '<br>' . $text_manual;
        $this->lang['error_create_file'] = $this->lang('error_create_file') . '<br>' . $text_manual;
        $this->lang['error_upload'] = $this->lang('error_upload') . '<br>' . $text_manual;
        $this->lang['error_unzip'] = $this->lang('error_unzip') . '<br>' . $text_manual;
    }
    ...
    private function stepUpload() {
        ...
        try {
            $this->uploadFile('sypex', $sxgeo_dir . '/sxgeocity.zip');
        } catch (\Exception $e) {
