...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="tab-general"><?= $general ?></div>
      ...
      <div class="tab-pane" id="tab-customer-group"><?= $text_customer_groups_info; ?></div>
...
<script type="text/javascript"><!--
    ...
    $(function() {
        $('#tabs').find('a[data-toggle="tab"]').on('shown.bs.tab', function(e) {
            ...
            if (!tab.find('div').length && $(this).data('url')) {
                ...
                el.autocomplete({
                    'source': function(request, response) {
                        ...
                        if (request && request.length > 2) {
                            xhr = $.get('<?= $url_search; ?>&term=' + encodeURIComponent(request) + '&short=' + (el.data('short') ? 1 : 0),
                                function(json) {
                                    response(json);
                                },
                                'json'
